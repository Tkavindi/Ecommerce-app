                ...
                return (
                  <tr key={e.id} className="border-b border-slate-900/20 text-gray-30 p-6 medium-14 text-center">
                    <td className="flexCenter">
                      <img src={e.image} alt="" height={43} width={43} className="rounded-lg ring-1 ring-slate-900/5 my-1"/>
                    </td>
                    <td>
          ...
          <div className="flex flex-col gap-10">
            ...
            <div>
              <div className="flexBetween py-4">
                ...
                <h4 className="text-gray-30 fomt-semibold">${getTotalCartAmount()}</h4>
              </div>
              <hr />
              <div className="flexBetween py-4">
                <h4 className="medium-16">Shipping Fee:</h4>
                <h4 className="text-gray-30 fomt-semibold">Free</h4>
              </div>
              <hr />
              <div className="flexBetween py-4">
