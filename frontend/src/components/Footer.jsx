    ...
    <>
      <footer className="flexCenter pb-24 pt-20">
        <div className="max_padd_container flex w-full flex-col gap-14"> 
          <div className="flex flex-col items-start justify-center gap-[10%] md:flex-row">
            ...
            <div className="flex flex-wrap gap-8 sm:justify-between md:flex-1">
              {FOOTER_LINKS.map((col) => (
                <FooterColumnn title={col.title} key={col.title}>
              ...
              <div className="flex flex-col gap-5">
                <FooterColumnn title={FOOTER_CONTACT_INFO.title}>
          ...
          <p className="text-center regular-14">2024 Shoppee | All rights reserved.</p>
        </div>
      </footer>
    </>
  );
...
const FooterColumnn = ({ title, children }) => {
  return (
    <>
      <div className="flex flex-col gap-5">
